...
CP: measuring T2 via the Carr-Purcell (90-180-180-180-...) sequence. The scope is set up to show the entire sequence with the 90 deg pulse at t = 0. The number after the underscore in each file indicates the delay time between subsequent 180 deg pulses.

MG: measuring T2 via the Meiboom-Gill (CP + phase shift) sequence. The scope is set up to show the entire sequence with the 90 deg pulse at t = 0. The number after the underscore in each file indicates the delay time between subsequent 180 deg pulses.